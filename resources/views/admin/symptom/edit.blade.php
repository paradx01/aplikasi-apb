    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-10">
                ...
                <form method="POST" action="{{ route('admin.symptoms.update', $symptom) }}" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            name="symptom_name" 
                            id="symptom_name" 
                            value="{{ old('symptom_name', $symptom->symptom_name) }}"
                        ...
                        <div class="space-y-2">
                            ...
                            <label class="flex items-center p-3 border border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                                <input 
                                    ...
                                    name="type" 
                                    value="umum" 
                                    {{ old('type', $symptom->type) == 'Umum' ? 'checked' : '' }}
                            ...
                            <label class="flex items-center p-3 border border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                                <input 
                                    ...
                                    name="type" 
                                    value="kritis" 
                                    {{ old('type', $symptom->type) == 'Kritis' ? 'checked' : '' }}
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-blue-700 dark:text-blue-200">
                                    <strong>Catatan:</strong> Perubahan tipe gejala akan mempengaruhi bobot scoring dalam sistem diagnosa. Gejala Kritis memiliki bobot 3x lebih tinggi dari Gejala Umum.
                                </p>
                            </div>
                        </div>
                    </div>
