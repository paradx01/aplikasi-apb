    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-10">
                ...
                <form method="POST" action="{{ route('admin.diseases.store') }}" class="space-y-6">
                    @csrf

                    <!-- Disease Name -->
                    <div>
                        <label for="disease_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
