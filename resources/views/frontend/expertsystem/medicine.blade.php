...
<body>
    ...
    <section id="topbar" class="fixed top-0 z-20 w-full transition duration-300">
        <div class="flex items-center justify-between gap-2 wrapper">
            <button onclick="goBackToDiagnosa()" class="p-2 bg-white rounded-full shadow-sm border border-gray-200">
    ...
    <div class="wrapper mt-6 pb-32">
        ...
        <div class="mb-6 bg-white rounded-2xl p-4 shadow-sm">
            <div class="flex items-center justify-between">
                ...
                <div class="flex flex-col items-center flex-1">
                    <div
                        class="w-10 h-10 rounded-full bg-primary flex items-center justify-center mb-2 ring-4 ring-primary/20">
                        <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
            ...
            <div class="mb-3">
                <div class="h-2 bg-gray-200 rounded-full overflow-hidden">
                    <div class="h-full rounded-full
                                {{ $diseaseData['confidence'] >= 70
                                    ? 'bg-green-500'
                                    : ($diseaseData['confidence'] >= 50
                                        ? 'bg-yellow-500'
                                        : 'bg-orange-500') }}"
                    ...
                    <a href="{{ route('frontend.product.details', $product->slug) }}"
                        ...
                        <div class="flex gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                @if ($product->category)
                                    <span
                                        class="inline-block text-xs text-gray-500 bg-gray-100 px-2 py-0.5 rounded mb-2">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div>
                                                ...
                                                @if ($product->stock > 0)
                                                    <p class="text-xs text-green-600 font-medium">Stok:
                                                        {{ $product->stock }}</p>
                                                @else
        ...
        @if (count($products) > 0 || count($productsWithWarning) > 0)
            <div class="mt-6 grid grid-cols-2 gap-3">
                <a href="{{ route('frontend.expertsystem.index') }}" onclick="resetExpertFlow()"
